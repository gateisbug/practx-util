...
describe('LocalStorage', () => {
  ...
  it('should set and retrieve an object', () => {
    jest.spyOn(Storage.prototype, 'getItem').mockReturnValue(JSON.stringify(testObject));
    localStorage.setObject(testObject);
    expect(window.localStorage.setItem).toHaveBeenCalledWith(testKey, JSON.stringify(testObject));
