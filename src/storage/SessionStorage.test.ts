...
describe('SessionStorage', () => {
  ...
  it('should set and retrieve a string item', () => {
    ...
    expect(window.sessionStorage.setItem).toHaveBeenCalledWith(testKey, testData);
  ...
  it('should set and retrieve an object', () => {
    ...
    expect(window.sessionStorage.setItem).toHaveBeenCalledWith(testKey, jsonString);
